...
export class ErrorHandler {
    ...
    printErrorData(callback, fun, config) {
        console.log(__classPrivateFieldGet(this, _ErrorHandler_errorMarkColor, "f").call(this, failMark), __classPrivateFieldGet(this, _ErrorHandler_errorColor, "f").call(this, this.error ? `${this.error}` : `This error has no data.`));
