...
export function execute(configs) {
    ...
    if (configs.length === 0) {
        ...
        cmd.stdout.on("pause", () => {
            var _a, _b;
            spinner.warn(`${(_a = configs[0].pauseText) === null || _a === void 0 ? void 0 : _a.accent}: ${(_b = configs[0].pauseText) === null || _b === void 0 ? void 0 : _b.text}` || '');
        });
        if (config.showDisconnect) {
            cmd.on("disconnect", () => {
                var _a, _b;
                console.log(`${(_a = configs[0].disconnectText) === null || _a === void 0 ? void 0 : _a.accent}: ${(_b = configs[0].disconnectText) === null || _b === void 0 ? void 0 : _b.text}`);
            });
        }
        if (config.showMessage) {
            cmd.on("message", (data) => {
                var _a, _b;
                console.log(`${(_a = configs[0].messageText) === null || _a === void 0 ? void 0 : _a.accent}: ${(_b = configs[0].messageText) === null || _b === void 0 ? void 0 : _b.text} - ${data}`);
            });
        }
        cmd.on("error", (err) => {
            var _a, _b;
            spinner.fail(`${(_a = config.errorText) === null || _a === void 0 ? void 0 : _a.accent}: ${(_b = config.errorText) === null || _b === void 0 ? void 0 : _b.text} - ${err.name}`);
        });
        cmd.on("close", () => {
            var _a, _b;
