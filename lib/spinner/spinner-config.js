export const SpinnerConfigFactory = (config) => {
    ...
    try {
        ...
        const defaulrConfig = {
            ...
            spawnText: {
                prefix: ((_a = spinner === null || spinner === void 0 ? void 0 : spinner.spawnText) === null || _a === void 0 ? void 0 : _a.prefix) || 'EXECUTING',
            ...
            succeedText: {
                prefix: ((_d = spinner === null || spinner === void 0 ? void 0 : spinner.succeedText) === null || _d === void 0 ? void 0 : _d.prefix) || 'COMPLETED EXECUTING',
            ...
            errorText: {
                prefix: ((_g = spinner === null || spinner === void 0 ? void 0 : spinner.errorText) === null || _g === void 0 ? void 0 : _g.prefix) || 'ERROR',
